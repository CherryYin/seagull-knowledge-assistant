...
- Project saved Asset Blocks into a revision-based Asset Outline Map with stable Block/Claim references; confirmed Refresh Apply updates only the formal Map, while Map-to-Asset changes first produce a read-only Document Patch preview with explicit structural and Claim-reference impact.
